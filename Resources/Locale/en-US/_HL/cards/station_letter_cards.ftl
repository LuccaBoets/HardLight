...
stationletter-card-desc = { $id ->
    ...
    [head_of_personnel]
        This card has no effect when played or discarded.
        You must play this card as the card for your turn if either the Quartermaster or the Clown is the other card in your hand.
        You can still choose to play this card even if you do not have the Quartermaster or the Clown.
