...
shipyard-console-save-success = Ship "{$ship}" saved successfully.
shipyard-console-save-failed = Failed to save ship "{$ship}".
shipyard-console-save-timeout = Saving ship "{$ship}" timed out before the client confirmed the file write.
